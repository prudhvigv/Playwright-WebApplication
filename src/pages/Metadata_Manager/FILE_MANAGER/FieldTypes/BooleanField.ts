...
const FIELD_NAME = (
  CreateFieldType.Boolean_Field.fieldName + faker.person.lastName()
).replace(/[^a-zA-Z0-9_]/g, '');
const FIELD_LABEL =
  CreateFieldType.Boolean_Field.fieldLabel + faker.person.jobDescriptor();
const PLACEHOLDER = CreateFieldType.Boolean_Field.placeholder;
const HELP_TEXT = CreateFieldType.Boolean_Field.helpText;
const FIELD_DESCRIPTION = CreateFieldType.Boolean_Field.fieldDescription;
const PROTECT_FIELD = CreateFieldType.Boolean_Field.protectField;
const IS_FIELD_SEARCHABLE = CreateFieldType.Boolean_Field.fieldSearchable;

const EDIT_FIELD_NAME = (
  EditFieldType.Boolean_Field.fieldName +
  faker.person.firstName() +
  faker.person.lastName()
).replace(/[^a-zA-Z0-9_]/g, '');
const EDIT_FIELD_LABEL =
  EditFieldType.Boolean_Field.fieldLabel + faker.person.jobDescriptor();
const EDIT_PLACEHOLDER = EditFieldType.Boolean_Field.placeholder;
const EDIT_HELP_TEXT = EditFieldType.Boolean_Field.helpText;
const EDIT_FIELD_DESCRIPTION = EditFieldType.Boolean_Field.fieldDescription;
const EDIT_PROTECT_FIELD = EditFieldType.Boolean_Field.protectField;
const EDIT_IS_FIELD_SEARCHABLE = EditFieldType.Boolean_Field.fieldSearchable;
...
export class Boolean extends BaseClass {
  ...
  async CREATE_BOOLEAN_FIELD() {
    Log.info('Creating Boolean field');
    await this.fieldType.selectFieldType('Boolean');
